...
<script type="text/javascript">
    function cekfeederid() {
            ...
            $.post("<?=site_url('reqempty/cekfeeder')?>",
              {
                feederid: id
              },
...
<section class="content" style="margin-top: 10px;">
                  ...
                  <div class="col-6">
                     <div class="float-sm-right">
                        ...
                        <?php
                            ...
                            $url = 'reqempty/process/'.str_replace("/","@",$requestno);
                            $urledit = 'reqempty/edit/'.str_replace("/","@",$requestno);
                            // echo $urledit;
                            $urlDel = 'reqempty/del/'.str_replace("/","@",$requestno);
                            if ($reqstatus < 1) 
                            {
                        ?>
    ...
    function updateData(id, type){
        ...
        if (type == "add") {
            $.post("<?=site_url('reqempty/adddetail')?>",
              {
                requestno : requestno,
                lingrid : lingrid,
                contqty : contqty,
          ...
          if (r == true) {
            ...
            $.post("<?=site_url('reqempty/hapusdetail')?>",
              {
                requestno : requestno,
                lingrid : lingrid,
                contqty : contqty,
            ...
            $.post("<?=site_url('reqempty/updatedetail')?>",
              {
                requestno : requestno,
                lingrid : lingrid,
                contqty : contqty,
