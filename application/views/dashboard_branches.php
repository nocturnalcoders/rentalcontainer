...
foreach ($t_boxops_active_branch as $key => $valA) {
...
foreach ($t_boxops_complete_branch as $key => $valA) {
...
<section class="content-header">
    ...
    <h1> <?php  if ($this->fungsi->user_login()->divbran == 'GTN-MES') 
                 { echo "GTN - MEDAN" ;}
                 else if ($this->fungsi->user_login()->divbran == 'GTN-BDJ') 
                 { echo "GTN - BANJARMASIN" ;}
                 else
