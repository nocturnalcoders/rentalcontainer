          ...
          <div class="card card-outline card-info">
            ...
            <form action="<?=site_url($url)?>" method="post" id="myForm">
                  ...
                  <div class="row upp">
                    ...
                    <div class="col-8 col-md-6 form-group row">
                      <label class="col-sm-3 col-form-label not-bold">Reff Date</label>
                      <div class="col-sm-5">
                        <div class="input-group date" id="releasedate" data-target-input="nearest">
                          <input class="form-control form-control-sm datetimepicker-input" data-target="#releasedate" name="releasedate" id="releasedateVal" data-toggle="datetimepicker" value="<?php echo $releasedate ?>" autocomplete="off" <?php echo $disabled ?>>
                          <div class="input-group-text" data-target="#releasedate" data-toggle="datetimepicker"><i class="fa fa-calendar"></i></div>
                        </div>
                      </div>
                    </div>
                    <div class="col-8 col-md-6 form-group row">
                  ...
                  <div class="row upp">
                    ...
                    <div class="col-8 col-md-6 form-group row">
                      ...
                      <div class="col-sm-5">
                        ...
                        <input type="text" name="divbran" id="divbran" required value="<?php echo $divbran ?>" readonly>
                      </div>
                    </div>
                  </div>
                            ...
                            <thead >
                              ...
                              <thead class="bg-info">
                                <tr>
                                  ...
                                  <th class="text-center" style="width:15%">QTY Assign</th>
                              ...
                              <tbody id="bodyTable">
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td>
                                      <input type="number" name="contqtyasg" id="contqtyasg<?php echo $no?>" value="<?php echo $value['contqtyasg'] ?>" class="form-control form-control-sm">
                                    </td>
                                    <td><?php echo $value['contsize']. $value['conttype'] ?></td>
                                    <td>
                                      <button type="button" class="btn btn-primary btn-rounded btn-sm my-0" onclick="updateDo(<?php echo $value['lingrid'] ?>, <?php echo $value['contqtyaprv'] ?>, <?php echo $value['contqtyasg'] == "" ? "0" : $value['contqtyasg'] ?>, <?php echo $no?>, 'update')"><i class="fa fa-file-alt"></i></button></td>
                                  </tr>
                                <?php
                                $no++;
                                } ?>
                        ...
                        <div class="row upp"> 
                          <div class="col-12 col-md-12 form-group row">
                            <label class="col-sm-4 col-form-label not-bold">Destination</label>
                              <div class="col-sm-7">
                              <input type="text" name="destination" id="destination" class="form-control form-control-sm" placeholder="destination" required value="<?php echo $destination ?>" >
                              </div>
                          </div>
                        </div>
