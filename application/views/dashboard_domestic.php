...
foreach ($t_boxops_branches as $key => $val) {
...
$t_boxops_branches_approved_jmlcont20 = "";
$t_boxops_branches_approved_jmlcont40 = "";
$t_boxops_branches_approved_jmlconttotal = "";
$t_boxops_branches_approved_jmlcont20_arr = array();
$t_boxops_branches_approved_jmlcont40_arr =array();
$t_boxops_branches_approved_jmlconttotal_arr =array();

foreach ($t_boxops_branches_approved as $key => $val) {

    $t_boxops_branches_approved_jmlcont20  .= "".$val['jmlcont20'].",";
    $t_boxops_branches_approved_jmlcont20_arr[] = $val['jmlcont20'];

    $t_boxops_branches_approved_jmlcont40  .= "".$val['jmlcont40'].",";
    $t_boxops_branches_approved_jmlcont40_arr[] = $val['jmlcont40'];


    $t_boxops_branches_approved_jmlconttotal  .= "".$val['jmlconttotal'].",";
    $t_boxops_branches_approved_jmlconttotal_arr[] = $val['jmlconttotal'];

}

$t_boxops_branches_approved_jmlcont20  = rtrim($t_boxops_branches_approved_jmlcont20, ",");
$t_boxops_branches_approved_jmlcont40  = rtrim($t_boxops_branches_approved_jmlcont40, ",");
$t_boxops_branches_approved_jmlconttotal  = rtrim($t_boxops_branches_approved_jmlconttotal, ",");
...
foreach ($t_boxops_active_domestic as $key => $valA) {
...
foreach ($t_boxops_complete_domestic as $key => $valA) {
...
<section class="content-header">
    ...
    <h1> <?php  if ($this->fungsi->user_login()->divbran == 'GTN-JKT') 
                 { echo "GTN - JAKARTA" ;}
                 else
                 { echo $this->fungsi->user_login()->divbran ; }
    ...
    <p></p>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo number_format(array_sum($t_boxops_jmlconttotal_arr),0) ?>&nbsp;Boxes</h3>
                <h6>Container 20' : <?php echo number_format(array_sum($t_boxops_jmlcont20_arr),0) ?></h6>
                <h6>Container 40' : <?php echo number_format(array_sum($t_boxops_jmlcont40_arr),0) ?></h6>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
              <h3><?php echo number_format(array_sum($t_boxops_branches_approved_jmlconttotal_arr) - (array_sum($t_boxops_active_jmlcont20_arr) + array_sum($t_boxops_active_jmlcont40_arr)) - (array_sum($t_boxops_complete_jmlcont20_arr) + array_sum($t_boxops_complete_jmlcont40_arr)),0) ?>&nbsp;Boxes</h3>
                <h6>Container 20' : <?php echo number_format(array_sum($t_boxops_branches_approved_jmlcont20_arr) - array_sum($t_boxops_active_jmlcont20_arr) - array_sum($t_boxops_complete_jmlcont20_arr),0) ?></h6>
                <h6>Container 40' : <?php echo number_format(array_sum($t_boxops_branches_approved_jmlcont40_arr) - array_sum($t_boxops_active_jmlcont40_arr) - array_sum($t_boxops_complete_jmlcont40_arr),0) ?></h6> 
             </div>
              <div class="icon">
        ...
        <div class="row">  <!-- BUAT WOR DULU JANGAN LUPPAA -->
            ...
            <section class="col-lg-12 connectedSortable">
                <div class="card">
                  ...
                  <h5 class="card-title"><b>Branches - Pending Container Request  </b></h5>
                                ...
                                <table id="nothing" class="table table-sm table-hover table-bordered">
                                    <thead class="bg-info"> 
                                        <tr> 
                                            ...
                                            <th class="auto-style">Branches</th>
                                            <th class="auto-style">Container 20'</th>
                                            <th class="auto-style">Container 40'</th>
                                            <th class="auto-style">Total Boxes</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                       ...
                                       <?php 
                                        $no = 1;
                                        foreach($t_boxops_all_pending_fordomestic->result() as $key => $data) {
                                         
                                          ?>
                                        <tr> 
                                            <td class="auto-style"><b><?=$data->divbran?></b></td>
                                            <td class="auto-style"><b><?=$data->jmlcont20?></b></td>
                                            <td class="auto-style"><b><?=$data->jmlcont40?></b></td>
                                            <td class="auto-style"><b><?=$data->jmlconttotal?></b></td>
                                            <!-- <td>satu</td> -->
                                        </tr>
                                        <?php 
                                        $no++;
         ...
         <div class="row">  <!-- BUAT WOR DULU JANGAN LUPPAA -->
            ...
            <div class="card">
                  ...
                  <div class="chart">
                      ...
                      <div class="col-md-3">
                          <p class="text-center">
                          <strong>Total Boxes Composition</strong>
                          </p>
                      ...
                      <div class="col-md-1">
                          ...
                          <div class='my-legend'>
                              ...
                              <ul class='legend-labels'>
                                  <li><span style='background:#f39c12;'>20 '</span></li>
                                  <li><span style='background:#045A8D;'>40 '</span></li>
                  ...
                  <div class="card-footer">
                      ...
                      <div class="col-sm-3 col-6">
                          ...
                          <h5 class="description-header"><?php echo number_format(array_sum($t_boxops_divbran_jmlcont20_arr),0) ?></h5>
                      ...
                      <div class="col-sm-3 col-6">
                          ...
                          <h5 class="description-header"><?php echo number_format(array_sum($t_boxops_divbran_jmlcont40_arr),0) ?></h5>
                      ...
                      <div class="col-sm-3 col-6">
                          ...
                          <h5 class="description-header"><?php echo number_format(array_sum($t_boxops_divbran_jmlconttotal_arr),0) ?></h5>
                ...
                <table id="nothing" class="table table-sm table-hover table-bordered">
                    ...
                    <tbody>
                      <?php 
                        $no = 1;
                       // print_r($row->result());
                        foreach($t_boxops_branches_pending_detail->result() as $key => $data) {
                        ...
                        <tr> 
                            ...
                            <td><?=$data->divbran?></td>
                            <td><a href="<?=site_url('reqempty/edit/')?><?php echo str_replace("/","@",$data->requestno) ?>"><?=$data->requestno?></a></td>
                ...
                <table id="nothing" class="table table-sm table-hover table-bordered">
                    ...
                    <tbody>
                      <?php 
                        $no = 1;
                       // print_r($row->result());
                        foreach($t_boxops_branches_approved_detail->result() as $key => $data) {
                         // $divbran = $data->divbran;
                          ?>
                ...
                <table id="nothing" class="table table-sm table-hover table-bordered">
                    ...
                    <tbody>
                      <?php 
                        $no = 1;
                       // print_r($row->result());
                        foreach($t_boxops_active_branch_detail->result() as $key => $data) {
                         // $divbran = $data->divbran;
                          ?>
                        ...
                        <tr> 
                           ...
                           <!--  <td><?=$this->fungsi->cari_donumber_dari_dofeeder($data->donumber)->divbran?></td>  -->
                            ...
                            <!-- <td><a href="<?=site_url('reqcontainer/edit/')?><?php echo str_replace("/","@",$data->requestno) ?>"><?=$data->requestno?></a></td> -->
                            <td><a href="<?=site_url('assignfeeder/asgnfeeder/')?><?php echo str_replace("/","@",$data->donumber) ?>"><?=$data->donumberfeeder?></a></td>
                            <td><?=$data->dodate?></td> 
                            <td><?=$data->jmlcont20?></td>
                            <td><?=$data->jmlcont40?></td>
                            <td><?=$data->jmlcont20 + $data->jmlcont40?></td>
                            <td><a href="<?=site_url('containerno/caridaridashboard/')?><?php echo str_replace("/","@",$data->donumberfeeder) ?>"><?php echo "Containers"; ?></a></td>
                        </tr>
                        <?php 
                        $no++;
                        } 
                ...
                <table id="noSearch" class="table table-sm table-hover table-bordered">
                    ...
                    <tbody>
                      <?php 
                        $no = 1;
                       // print_r($row->result());
                        foreach($t_boxops_complete_branch_detail->result() as $key => $data) {
                         // $divbran = $data->divbran;
                          ?>
...
<script type="text/javascript">
   ...
   //==================================================
      ...
      //====================================================
      var areaChartData = {
            labels  : [<?php echo $t_boxops_divbran_date_has ?>],
            datasets: [
                ...
                data                : [<?php echo   $t_boxops_divbran_jmlcont20  ?>]
                },
                {
                label               :  "Container 40'",
                ...
                data                : [<?php echo $t_boxops_divbran_jmlcont40  ?>]
                },
...
/* 
 ...
 //==================================================
        ...
        datasets: [
          {
            data: [
            <?php echo array_sum($t_boxops_divbran_jmlcont40_arr) ?>,
            <?php echo array_sum($t_boxops_divbran_jmlcont20_arr) ?>,
            ],
