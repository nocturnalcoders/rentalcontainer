      ...
      <!-- <div class="container-fluid"> -->
        <div class="row">
          <div class="col-12">
            <div class="card card-outline card-info">
              <div class="card-header">
                <div class="row">
                  <div class="col-8">
                    <h3>
                    Request Repo Container / FreeUse - Branches
                    </h3>
                  </div>
                  <div class="col-4">
                    <div class="float-sm-right">
                    <a href="<?=site_url('reqcontainer/add')?>" class="btn btn-info btn-flat">
           ...
           <form action="<?=site_url('reqcontainer/cari')?>" method="post">
              <div class="row">
              <div class="col-md-7">
                        ...
                        <tr> 
                            ...
                            <td><?php  if($data->reqstatus == 0) 
                                { echo "Pending" ; } 
                                        ...
                                        echo  "DO# : " ;
                                ?>
                                <a href="<?=site_url('reqcontainer/edit/')?><?php echo str_replace("/","@",$requestno) ?>"><?=$data->donumber?></a>
                                <?php } ?>
                              </td>
                        </tr>
                        <?php 
